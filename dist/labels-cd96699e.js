...
function addLabelToModel(XYZpos, id) {
  ...
  label.position.copy(XYZpos);
    labelObject.addEventListener('mouseover', () => {
      labelObject.classList.add('fa-beat-fade');
    });
    labelObject.addEventListener('mouseout', () => {
      labelObject.classList.remove('fa-beat-fade');
    });
