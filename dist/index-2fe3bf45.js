...
function removeLabelFromScene(id){
  ...
  // const CSS2DObjectToRemove = scene.children.find(object => object.element.dataset.id === id);
  console.log(scene.children.find(object => console.log(object.element.dataset)));
