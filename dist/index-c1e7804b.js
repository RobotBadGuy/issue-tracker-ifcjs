...
function removeLabelFromScene(id){
  ...
  const issueSymbols = document.querySelectorAll('[id="issue-symbol"]');
  Array.from(issueSymbols);
  // const nodeToRemove = scene.children.CSS2DObject.element.dataset.id;
  const nodeToRemove = labelRenderer.domElement.querySelector('[data-id="' + id + '"]');
  // const elementToRemove = labelRendererDOM.querySelector('[data-id="' + id + '"]');
  // if (elementToRemove){
  //   labelRendererDOM.removeChild(elementToRemove);
  // }
  // console.log(nodeToRemove);
  console.log(labelRenderer.domElement.getElementById(labelRendererDOM));
  labelRenderer.domElement.removeChild(nodeToRemove);
  labelRenderer.domElement.nodeToRemove;
}
