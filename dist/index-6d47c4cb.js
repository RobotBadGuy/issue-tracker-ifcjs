...
window.addEventListener("dblclick", (event) => {
  ...
  // Get Screenshot
  const screenshotContext = document.getElementById('labelrendererdom');
  console.log(screenshotContext);
  const screenshotData = screenshotContext.toDataURL('image/png');
