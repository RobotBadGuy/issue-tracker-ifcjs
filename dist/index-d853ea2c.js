...
const addLabelToIssuesOverlay = (labelItem, labelImg, currentViewPos) => {
  ...
  const LabelXPos = currentViewPos.x;
  const LabelYPos = currentViewPos.y;
  const LabelZPos = currentViewPos.z;
  console.log(LabelXPos);
  console.log(LabelYPos);
  console.log(LabelZPos);
...
window.addEventListener("dblclick", (event) => {
  ...
  const currentViewpoint = cameraControls.getPosition();
  console.log(currentViewpoint.x);
  console.log(currentViewpoint.y);
  console.log(currentViewpoint.z);
...
function addLabelsToOverlay(UpdatedLabelsArray, updatedImagesArray, currentViewPos){
  ...
  UpdatedLabelsArray.map((label) => {
    ...
    addLabelToIssuesOverlay(label, matchingImg, currentViewPos);
  });
}
