...
window.addEventListener("dblclick", (event) => {
  ...
  addLabelsToOverlay(labelsArray);
...
function addLabelsToOverlay(UpdatedLabelsArray){
  updateIssuesOverlay();
  UpdatedLabelsArray.map((label) => {
    addLabelToIssuesOverlay(label);
  });
...
function removeImageFromArray(id) {
  imagesArray = imagesArray.filter((item) => item.element.dataset.id !== id);
}
...
export { addLabelToModel as a, addLabelToIssuesOverlay as b, camera as c, canvas as d, removeImageFromArray as e, removeLabelFromArray as r, scene as s, updateIssuesOverlay as u };
