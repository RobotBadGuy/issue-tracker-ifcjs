...
function zoomToIssue(posX, posY, posZ){
    ...
    cameraControls.setLookAt(posX, posY, 20, 0, 10, 0, true);
}
...
function setupIssuesFunctionality() {
  issueItemsOverlayDOM.addEventListener('click', function(e){
    ...
    if(parent.classList.contains('issues-item-goto-btn')){
      ...
      const posX = articleParent.parentElement.dataset.data-x;
      const posY = articleParent.parentElement.dataset.data-y;
      articleParent.parentElement.dataset.data-z;

      zoomToIssue(posX, posY);
    }
  });
}
