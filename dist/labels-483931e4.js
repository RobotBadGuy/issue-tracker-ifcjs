...
// ---------------ADD LABELS--------------- //
function addLabel(htmlType, textCont, XYZpos, classType){

  const label = document.createElement(`${htmlType}`);
  ...
  // return labelObject;
  return `
    <article class="issues-item" data-id="">
    ...
    <div>
      ...
      <button class="issues-item-remove-btn">remove</button>
    </div>
    <!-- info toggle -->
    <div>
      <button class="issues-item-info-btn">
...
export { CSS2DRenderer as C, addLabel as a };
