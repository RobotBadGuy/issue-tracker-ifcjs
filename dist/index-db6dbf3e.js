...
const addLabelToIssuesOverlay = (labelItem, labelImg) => {
  ...
  article.setAttribute("data-id", LabelXPos);
  article.setAttribute("data-x", labelItemID);
  article.setAttribute("data-y", labelItemID);
  article.setAttribute("data-z", labelItemID);
  article.innerHTML = `
            <article class="issues-item" data-id="${labelItemID} data-x="${LabelXPos}" data-y="${LabelYPos}" data-z="${LabelZPos}"">
