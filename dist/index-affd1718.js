...
import { a as Vector3, M as Matrix4, O as Object3D, V as Vector2, S as Scene, A as AxesHelper, b as box, G as GridHelper, P as PerspectiveCamera, H as HemisphereLight, W as WebGLRenderer, R as Raycaster, s as sun, g as geomObject, e as edgesWireframe, c as MOUSE, d as Vector4, Q as Quaternion, f as Spherical, B as Box3, h as Sphere, i as MathUtils, j as earth, C as Clock } from './planets-93b3a34a.js';
...
function setupIssuesFunctionality() {
  issueItemsOverlayDOM.addEventListener('click', function(e){
    ...
    if(parent.classList.contains('issues-item-goto-btn')){
      console.log(articleParent.parentElement);
