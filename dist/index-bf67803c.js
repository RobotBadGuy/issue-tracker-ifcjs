...
function removeLabelFromScene(id){
  ...
  const nodeToRemove = labelRendererDOM.querySelector('p[data-id="' + id + '"]');
  // console.log(labelRendererDOM);
  // console.log(issueSymbols);
  // console.log(typeof(nodeToRemove));
...
function removeLabelFromModel(id) {
  const label = document.getElementsByTagName('p[data-id="' + id + '"]');
  // console.log(labelRendererDOM););
  console.log(label);
  label.map(item => item.element.dataset.id === id);
