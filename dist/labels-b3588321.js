...
// ---------------REMOVE LABELS TO ISSUES ITEMS SIDE PANEL--------------- //

// ---------------ADD LABELS TO ISSUES ITEMS SIDE PANEL--------------- //

const issueItemsOverlayDOM = document.querySelector(".issues-items");
const addLabelToIssuesOverlay = (labelID, labelItem) => {
  console.log(labelID);
  console.log(labelItem.element.id);
  const article = document.createElement("article");
  article.classList.add("cart-item");
  article.setAttribute("data-id", labelID);
  article.innerHTML = `
            <article class="issues-item" data-id="${labelID}">
            ...
            <div>
              ...
              <button class="issues-item-remove-btn" data-id="${labelID}">remove</button>
            </div>
            <!-- info toggle -->
            <div>
              <button class="issues-item-info-btn" data-id="${labelID}">
...
export { CSS2DRenderer as C, addLabelToModel as a, addLabelToIssuesOverlay as b };
