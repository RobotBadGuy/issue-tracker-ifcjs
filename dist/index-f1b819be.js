...
window.addEventListener('dblclick', (event) => {
  ...
  const labels = addLabel('p', '<i class="fa-solid fa-location-dot"></i>', location, 'red');
...
export { CSS2DObject as C, camera as a, canvas as c, scene as s };
