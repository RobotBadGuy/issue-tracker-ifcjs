...
const CSS2Dcanvas = document.getElementById("three-canvas");
...
// https://threejs.org/docs/#examples/en/renderers/CSS2DRenderer
const labelRenderer = new CSS2DRenderer({CSS2Dcanvas});
...
window.addEventListener("dblclick", (event) => {
  ...
  const screenshotData = CSS2Dcanvascanvas.toDataURL('image/png');
