...
import { V as Vector3, M as Matrix4, O as Object3D, T as TrianglesDrawMode, a as TriangleFanDrawMode, b as TriangleStripDrawMode, L as Loader, c as LoaderUtils, F as FileLoader, C as Color, S as SpotLight, P as PointLight, D as DirectionalLight, d as MeshBasicMaterial, s as sRGBEncoding, e as MeshPhysicalMaterial, f as Vector2, I as InstancedMesh, g as TextureLoader, h as ImageBitmapLoader, B as BufferAttribute, i as InterleavedBuffer, j as LinearFilter, k as LinearMipmapLinearFilter, R as RepeatWrapping, l as PointsMaterial, m as Material, n as LineBasicMaterial, o as MeshStandardMaterial, p as DoubleSide, q as PropertyBinding, r as BufferGeometry, t as SkinnedMesh, u as Mesh, v as LineSegments, w as Line, x as LineLoop, y as Points, G as Group, z as PerspectiveCamera, A as MathUtils, E as OrthographicCamera, H as Skeleton, J as InterpolateLinear, K as AnimationClip, N as Bone, Q as Quaternion, U as NearestFilter, W as NearestMipmapNearestFilter, X as LinearMipmapNearestFilter, Y as NearestMipmapLinearFilter, Z as ClampToEdgeWrapping, _ as MirroredRepeatWrapping, $ as InterpolateDiscrete, a0 as FrontSide, a1 as InterleavedBufferAttribute, a2 as Texture, a3 as VectorKeyframeTrack, a4 as QuaternionKeyframeTrack, a5 as NumberKeyframeTrack, a6 as Box3, a7 as Sphere, a8 as Interpolant, a9 as Scene, aa as AxesHelper, ab as box, ac as GridHelper, ad as HemisphereLight, ae as WebGLRenderer, af as Raycaster, ag as MOUSE, ah as Vector4, ai as Spherical, aj as sun, ak as geomObject, al as edgesWireframe, am as earth, an as Clock } from './planets-69be5d41.js';
...
window.addEventListener("dblclick", (event) => {
  ...
  const currentViewpoint = new CustomVector3(currViewpoint.x, currViewpoint.y, currViewpoint.z, id);
  viewpointArray.push({
    id: currentViewpoint.id,
    position: new CustomVector3(currentViewpoint.x, currViewpoint.y, currViewpoint.z),
  });
...
function addLabelsToOverlay(UpdatedLabelsArray, updatedImagesArray, updatedPosArray){
  ...
  UpdatedLabelsArray.map((label) => {
    ...
    const matchingPos = updatedPosArray.find((pos) => pos.id === label.element.dataset.id);
...
export { addLabelToModel as a, addLabelToIssuesOverlay as b, camera as c, cameraControls as d, canvas as e, removeImageFromArray as f, removeViewpointFromArray as g, removeLabelFromArray as r, scene as s, updateIssuesOverlay as u };
