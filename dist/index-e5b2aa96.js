...
function zoomToIssue(id){
    const issuesGotoBtn = issuesItemsDOM.querySelectorAll('.issues-item-goto-btn');
    issuesGotoBtn.forEach(btn => {
...
function setupIssuesFunctionality() {
  issueItemsOverlayDOM.addEventListener('click', function(e){
    ...
    if(element.classList.contains('issues-item-goto-btn')){
      zoomToIssue();
    }
  });
}
...
const cameraControls$1 = new CameraControls(camera, canvas);
cameraControls$1.dollyToCursor = true;
cameraControls$1.draggingSmoothTime = 0.23;

cameraControls$1.setLookAt(20, 40, 20, 0, 10, 0, true);
...
function animate() {
  ...
  cameraControls$1.update(delta); //make orbit controls work at all times
...
export { addLabelToModel as a, addLabelToIssuesOverlay as b, camera as c, cameraControls$1 as d, canvas as e, removeImageFromArray as f, removeLabelFromArray as r, scene as s, updateIssuesOverlay as u };
